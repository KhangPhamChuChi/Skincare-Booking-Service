  ...
  return (
    <div className="typeofskin">
      ...
      <Card className="card-container">
        ...
        <Title level={4}>
          &quot;Da thường&quot; là một làn da cân bằng. Các vùng chữ T (trán,
          cằm và mũi) có thể là một chút dầu, nhưng nhìn chung độ dầu và độ ẩm
          cân bằng và da không quá nhờn hoặc quá khô.
        </Title>
